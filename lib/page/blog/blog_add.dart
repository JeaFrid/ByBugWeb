...
final RxString toptitleRx = "Merhaba, ByBug Blog!".obs;
final RxString titleRx = "ByBug Blog'un Işıltılı Bir Başlığı!".obs;
final RxString subtitleRx = "Bu açıklama, oldukça uzun olabilir mi?".obs;
final RxString imageRx =
    "https://raw.githubusercontent.com/JeaFrid/ByBugWeb/master/assets/images/logo-classic.png"
        .obs;
final RxString contentRx = "".obs;
final RxString buttonTextRx = "Daha fazla...".obs;
...
class BlogAddCard extends StatelessWidget {
  ...
  final ScrollController scrollView;
