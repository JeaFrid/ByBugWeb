...
class ColorConverter extends StatelessWidget {
  ...
  ///Rx Veriables
  final RxString colorValue = "#ffffff".obs;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: LayoutBuilder(
          builder: (p0, p1) {
            return p1.maxWidth > 900 ? pc(p1, context) : mobile(p1, context);
          },
        ));
  }

  Skeleton pc(BoxConstraints p1, BuildContext context) {
    return Skeleton(
      child: Column(
                    ...
                    CustomButton(
                      ...
                      event: () {
                        if (colorController.text.contains("#")) {
                          ...
                          ByBugDialg.error(context, p1, "Hex Hatası Algılandı.",
  ...
  Skeleton mobile(BoxConstraints p1, BuildContext context) {
    return Skeleton(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
